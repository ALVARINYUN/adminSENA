                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fw-bold text-success">
                                            <i class="bi bi-person-badge me-2"></i>Numero
                                        </label>
                                        <input type="text" class="form-control @error('number') is-invalid @enderror"
                                            name="number" value="{{ old('number', $computer->number) }}"
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fw-bold text-success">
                                            <i class="bi bi-person-badge me-2"></i>Marca
                                        </label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="brand" value="{{ old('brand', $computer->brand) }}"
                                            placeholder="Ej: Num serie">
                                        @error('number')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
