                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fw-bold text-success">
                                            <i class="bi bi-person-badge me-2"></i>Numero curso
                                        </label>
                                        <input type="text"
                                            class="form-control @error('course_number') is-invalid @enderror"
                                            name="course_number" value="{{ old('course_numbre', $course->course_number) }}"
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fw-bold text-success">
                                            <i class="bi bi-envelope me-2"></i>Dia
                                        </label>
                                        <input type="text" class="form-control @error('day') is-invalid @enderror"
                                            name="day" value="{{ old('day', $course->day) }}" placeholder="day">
                                        @error('day')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                     <div class="mb-4">
                                        ...
                                        <input type="text"
                                            ...
                                            name="area_id"
                                            value="{{ old('area_id', $course->training_center_id) }}"
                                            placeholder="area_id">
                                        @error('area_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('training_center_id', $course->training_center_id) }}"
